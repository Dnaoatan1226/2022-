...
int main()
{
	...
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程1.xls","w+");
	writeData(0,1);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程2.xls","w+");
	writeData(1,1);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程3.xls","w+");
	writeData(2,1);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程4.xls","w+");
	writeData(3,1);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程5.xls","w+");
	writeData(4,1);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程1.txt","w+");
	writeData(0,0);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程2.txt","w+");
	writeData(1,0);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程3.txt","w+");
	writeData(2,0);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程4.txt","w+");
	writeData(3,0);
	fp = fopen("C:\\Users\\81980\\Desktop\\软工\\课程5.txt","w+");
	writeData(4,0);
}
